      ...
      <div className="cta-banner__inner">
        ...
        <FadeUp delay={0.1}>
          <h2 className="cta-banner__title">
            ...
            <br />
            actually <span className="text-gradient">grows your business</span>
          </h2>
        </FadeUp>
        <FadeUp delay={0.2}>
          <p className="cta-banner__desc">
            Book a free 30-minute consultation. You&apos;ll speak directly with the
            developer — no sales reps, no account managers. Walk away with a
            clear action plan for your website, local SEO, and lead generation.
          </p>
        </FadeUp>
        <FadeUp delay={0.3}>
