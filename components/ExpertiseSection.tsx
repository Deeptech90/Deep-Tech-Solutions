          ...
          <div className="section-header">
            <div className="section-header__inner">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                ...
                {/* Social Links Cluster (Facebook, WhatsApp, Instagram, LinkedIn) */}
                <div className="flex items-center gap-4 pt-4 sm:pt-0 sm:ml-6">
                  ...
                  {/* WhatsApp */}
                  <a
                    href={`https://wa.me/${(process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || "918929490433").replace(/[^0-9]/g, "")}?text=Hello%20Deep%20Tech%20Solutions`}
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a
                    ...
                    title="Instagram: deeptechsolutions90"
                  >
                    <svg width="30" height="30" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group relative flex h-16 w-16 items-center justify-center rounded-2xl border border-[#3D3F41] bg-[#1E2022] text-[#9A9A9C] transition-all hover:scale-110 hover:border-[#0A66C2] hover:bg-[#0A66C2]/15 hover:text-[#0A66C2] shadow-lg"
                    aria-label="LinkedIn Profile"
                    id="expertise-linkedin"
