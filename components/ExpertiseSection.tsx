              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                ...
                <div className="flex items-center gap-3 pt-2 sm:pt-0">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group relative flex h-11 w-11 items-center justify-center rounded-xl border border-[#3D3F41] bg-[#1E2022] text-[#9A9A9C] transition-all hover:scale-110 hover:border-[#1877F2] hover:bg-[#1877F2]/15 hover:text-[#1877F2] shadow-md"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group relative flex h-11 w-11 items-center justify-center rounded-xl border border-[#3D3F41] bg-[#1E2022] text-[#9A9A9C] transition-all hover:scale-110 hover:border-[#25D366] hover:bg-[#25D366]/15 hover:text-[#25D366] shadow-md"
                    aria-label="WhatsApp"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group relative flex h-11 w-11 items-center justify-center rounded-xl border border-[#3D3F41] bg-[#1E2022] text-[#9A9A9C] transition-all hover:scale-110 hover:border-[#E4405F] hover:bg-[#E4405F]/15 hover:text-[#E4405F] shadow-md"
